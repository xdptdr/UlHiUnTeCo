...
public class TestCN extends AbstractTest {
	...
	public TestCN() {
		super(new Class<?>[] { BarCN.class, FooCN.class });
	}
	...
	private void create() {
		...
		try {
			...
			FooCN foo1 = new FooCN(foo1Name);
			FooCN foo2 = new FooCN(foo2Name);
			BarCN bar1 = new BarCN(bar1Name);
			BarCN bar2 = new BarCN(bar2Name);
			foo1.addBar(bar1);
			foo1.addBar(bar2);
			foo2.addBar(bar1);
			foo2.addBar(bar2);
	...
	public void dumpTables() throws SQLException {
		...
		tableOutputStream.println(dumpTable("ulhiunteco.FOO_CN"));
		tableOutputStream.println(dumpTable("ulhiunteco.BAR_CN"));
		tableOutputStream.println(dumpTable("ulhiunteco.FOO_BAR_CN"));
	}
